...
function deploy_node() {
    ...
    curl -L https://github.com/block-mesh/block-mesh-monorepo/releases/download/v0.0.402/blockmesh-cli-x86_64-unknown-linux-gnu.tar.gz -o blockmesh-cli.tar.gz
